...
Houve essencialmente a preocupação de testar tudo o que foi feito em três tipos de testes diferentes. O primeiro foi o teste manual, depois com a utilização do software Insomnia e por último foram realizados testes unitários.  Foi instalado e configurado o Python decouple por motivo de segurança.
